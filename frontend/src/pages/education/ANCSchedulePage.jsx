...
const ancVisits = [
  {
    ...
    important:
      "Register early; the first visit sets the foundation for your entire pregnancy care.",
  ...
  },
  {
    ...
    important:
      "You may hear your baby's heartbeat for the first time at this visit!",
  ...
  },
  {
    ...
    important:
      "The 20-week scan checks for major physical abnormalities in the baby.",
  ...
  },
  {
    ...
    important:
      "Start thinking about your birth plan and discussing it with your nurse.",
  ...
  },
  {
    ...
    what: [
      ...
      "Discuss birth preparedness and signs of labour",
      "Pack your hospital bag (do this by week 36)",
      "Review emergency contacts and hospital route",
    ],
    important:
      "Begin actively preparing for birth at this point. Know how to get to the hospital quickly.",
  ...
  },
  {
    ...
    important:
      "You are almost there! Attend every appointment; complications can arise quickly near term.",
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <p className="text-sm text-text-secondary leading-relaxed mb-4">
        The WHO recommends at least{" "}
        <strong>8 antenatal care (ANC) visits</strong> during pregnancy. Each
        visit protects both you and your baby.
      </p>
      ...
      <div className="flex items-center gap-2 p-3.5 bg-sage-50 border border-sage-200 rounded-xl mb-6">
        ...
        <p className="text-xs text-sage-700">
          Based on WHO 2016 ANC recommendations and FMOH Nigeria guidelines.
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-border p-4 mb-6">
        ...
        <ul className="space-y-1.5">
          {whyAttend.map((w) => (
            ...
            >
              <span
                className="w-1.5 h-1.5 rounded-full bg-sage-400 shrink-0 mt-2"
                aria-hidden
              />
              {w}
            </li>
      ...
      {/* Timeline */}
      <h2 className="font-semibold text-base text-text-primary mb-4">
        Your ANC Visit Timeline
      </h2>
          ...
          <div key={visit.visit} className="flex gap-4">
            ...
            <div className="flex flex-col items-center">
              ...
              {i < ancVisits.length - 1 && (
                <div
                  className="w-0.5 bg-rose-200 flex-1 mt-1 mb-0"
      ...
      <div className="bg-red-50 rounded-2xl border border-red-200 p-4 mb-5">
        <p className="font-semibold text-sm text-red-800 mb-1">
          ⚠️ Never Miss an ANC Appointment
        </p>
        <p className="text-xs text-red-700 leading-relaxed">
          Missing visits puts you and your baby at risk. If you cannot attend,
          contact your health facility to reschedule as soon as possible. Tell
          your nurse about any symptoms between visits.
        </p>
      </div>

      <div className="p-4 bg-rose-50 rounded-2xl border border-rose-200">
        <p className="text-sm font-semibold text-text-primary mb-1">
          Questions about your ANC visits?
        </p>
        <p className="text-xs text-text-secondary mb-3">
          Ask MamaGuide about what to expect at each visit.
        </p>
        <Link
          to={ROUTES.CHAT}
