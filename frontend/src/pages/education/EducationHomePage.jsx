...
import {
  Baby, Apple, AlertTriangle, Calendar, Syringe, Brain,
  Package, Droplets, Milk, ArrowRight, BookOpen, Shield,
} from 'lucide-react'
    ...
    <div className="max-w-4xl mx-auto px-4 py-6">
      <div className="mb-6">
        <div className="flex items-center gap-2.5 mb-2">
          ...
          <h1 className="font-display font-bold text-xl text-text-primary">Health Education</h1>
        </div>
        <p className="text-sm text-text-secondary leading-relaxed">
          Evidence-based maternal health information from WHO guidelines and Nigerian ANC protocols.
        </p>
      </div>
      ...
      <div className="flex items-center gap-2 p-3.5 bg-sage-50 border border-sage-200 rounded-xl mb-6">
        ...
        <p className="text-xs text-sage-700 leading-relaxed">
          <strong>All content</strong> is based on WHO ANC guidelines and Federal Ministry of Health Nigeria protocols.
        </p>
      </div>
        ...
        {educationModules.map(mod => (
          ...
          >
            <div className="flex items-start gap-3.5">
              <span className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 ${mod.color}`} aria-hidden>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <Badge variant={mod.badge.variant} size="sm">{mod.badge.text}</Badge>
                </div>
                <p className="text-xs text-text-secondary leading-relaxed mb-2">{mod.desc}</p>
              ...
              <ArrowRight className="w-4.5 h-4.5 text-text-muted group-hover:text-rose-700 shrink-0 mt-2 transition-colors" aria-hidden />
            </div>
          </Link>
        ))}
      </div>
