...
const hospitalBag = [
  {
    ...
    items: [
      ...
      {
        text: "Sanitary pads (maternity size), at least 2 packs",
        done: false,
      },
      { text: "Underwear: loose cotton (3–4 pairs)", done: false },
      {
        text: "Toiletries: soap, toothbrush, toothpaste, deodorant",
        done: false,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "Cord care supplies (as recommended by your facility)",
        done: false,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "Hospital registration card (if already registered)",
        done: false,
      },
      {
        text: "National health insurance (NHIS) card if applicable",
        done: false,
      },
...
const labourSigns = [
  {
    ...
    desc: "Contractions that come regularly, getting closer together (every 5 minutes or less) and lasting at least 60 seconds. This is the strongest sign of active labour.",
  },
  {
    sign: "Waters Breaking",
    desc: "A sudden gush or slow leak of clear or slightly pink fluid from your vagina. Your baby's membranes have ruptured. Go to hospital even if contractions haven't started.",
  },
  {
    sign: 'The "Show" (Mucus Plug)',
    desc: "A thick, jelly-like mucus (possibly with a little blood) comes out of the vagina. Labour may be hours or days away, but it's beginning.",
  },
  {
    sign: "Strong Back Pain",
    desc: "Persistent lower back pain that doesn't ease with position changes, often accompanying contractions.",
  },
];

const labourStages = [
  {
    stage: "Stage 1: Early Labour",
    desc: "Cervix opens from 0 to 10 cm. Contractions begin. This can take many hours (longer for first-time mothers). Stay calm, breathe, and time your contractions.",
  },
  {
    stage: "Stage 2: Active Labour and Pushing",
    desc: "Cervix is fully open. You'll feel a strong urge to push. Your baby moves through the birth canal. This stage usually lasts 1–2 hours but varies.",
  },
  {
    stage: "Stage 3: Delivery of Placenta",
    desc: "After baby is born, the placenta (afterbirth) is delivered. This usually takes 5–30 minutes. You may feel mild contractions.",
  },
];
    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          ...
          <p className="text-xs text-text-muted">
            Get ready for labour and delivery
          </p>
        </div>
      </div>
      <p className="text-sm text-text-secondary leading-relaxed mb-6">
        Being prepared for birth reduces fear and helps you stay calm. Start
        getting ready from <strong>week 34–36</strong> of your pregnancy.
      </p>
      ...
      <section className="mb-6">
        ...
        <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-xl">
          <p className="text-xs text-red-700 font-semibold">
            Go to hospital immediately if: waters break, bleeding occurs, baby
            stops moving, or contractions are 5 minutes apart.
          </p>
        </div>
      </section>
      ...
      <section className="mb-6">
        ...
        <div className="space-y-4">
          {hospitalBag.map((cat) => (
            <div
              key={cat.category}
              className={cn("rounded-2xl border p-4", colorMap[cat.color])}
            >
      ...
      <div className="bg-red-50 border border-red-200 rounded-2xl p-4 mb-5">
        ...
        <ul className="space-y-1.5 text-xs text-red-700">
          <li className="flex items-start gap-1.5">
            <CheckCircle className="w-3.5 h-3.5 shrink-0 mt-0.5 text-red-500" />{" "}
            Know the address and phone number of your nearest maternity hospital
          </li>
          <li className="flex items-start gap-1.5">
            <CheckCircle className="w-3.5 h-3.5 shrink-0 mt-0.5 text-red-500" />{" "}
            Have transport arranged for labour; do not plan to walk or use
            okada
          </li>
          <li className="flex items-start gap-1.5">
            <CheckCircle className="w-3.5 h-3.5 shrink-0 mt-0.5 text-red-500" />{" "}
            Have 2–3 people who know your due date and can help at any time
          </li>
          <li className="flex items-start gap-1.5">
            <CheckCircle className="w-3.5 h-3.5 shrink-0 mt-0.5 text-red-500" />{" "}
            Have money saved for hospital costs before labour starts
          </li>
          <li className="flex items-start gap-1.5">
            <CheckCircle className="w-3.5 h-3.5 shrink-0 mt-0.5 text-red-500" />{" "}
            Save emergency contact: 112 (national) or your midwife's number
          </li>
        </ul>
      </div>
      ...
      <div className="p-4 bg-rose-50 rounded-2xl border border-rose-200">
        <p className="text-sm font-semibold text-text-primary mb-1">
          Questions about preparing for birth?
        </p>
        <p className="text-xs text-text-secondary mb-3">
          Ask MamaGuide anything about labour and delivery.
        </p>
        <Link
          to={ROUTES.CHAT}
