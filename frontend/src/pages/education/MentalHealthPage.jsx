...
const commonFeelings = [
  {
    ...
    desc: "Worrying about your baby's health, labour, or parenting is very common; you are not alone.",
  },
  {
    emoji: "😢",
    feeling: "Mood swings",
    desc: "Hormonal changes during pregnancy can cause sudden shifts in mood. This is normal.",
  },
  {
    emoji: "😔",
    feeling: "Sadness or feeling low",
    desc: "Some women experience depression during pregnancy (antenatal depression), not just after birth.",
  },
  {
    emoji: "😴",
    feeling: "Exhaustion and stress",
    desc: "Being tired all the time can affect your mood and feelings. Rest is not a luxury, it's essential.",
  },
  {
    emoji: "💭",
    feeling: "Fear about the future",
    desc: "First-time mothers and women with previous pregnancy loss often feel increased fear; seek support.",
  },
];
...
const selfCareStrategies = [
  {
    emoji: "🚶",
    title: "Stay gently active",
    desc: "Light walking, prenatal yoga, or swimming releases feel-good hormones. Aim for 20–30 minutes most days.",
  },
  {
    emoji: "🛌",
    title: "Prioritise sleep and rest",
    desc: "Sleep on your left side from mid-pregnancy. Use pillows for support. Rest is not laziness; it is healing.",
  },
  {
    emoji: "🗣️",
    title: "Talk about your feelings",
    desc: "Share how you feel with your partner, a trusted friend, your nurse, or MamaGuide. Silence makes it worse.",
  },
  {
    emoji: "🙏",
    title: "Practise relaxation",
    desc: "Deep breathing, prayer, or gentle meditation can reduce anxiety. Even 5 minutes a day helps.",
  },
  {
    emoji: "🥗",
    title: "Nourish your body",
    desc: "Good nutrition supports mental health too. Omega-3-rich foods (fish, eggs) are linked to lower depression risk.",
  },
  {
    emoji: "👥",
    title: "Build your support system",
    desc: "Identify who will help you after birth. A support network is protective against postpartum depression.",
  },
];
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <p className="text-sm text-text-secondary leading-relaxed mb-6">
        ...
        health during pregnancy. <strong>You are not alone</strong>; many women
        experience emotional challenges at this time.
      </p>

      {/* Reassurance banner */}
      <div className="bg-purple-50 border border-purple-200 rounded-2xl p-4 mb-6">
        <p className="text-sm text-purple-800 leading-relaxed">
          <span className="font-bold">💜 Remember:</span> Asking for help is a
          sign of strength, not weakness. Your feelings are valid. With the
          right support, you can and will feel better.
        </p>
      </div>
      ...
      <section className="mb-6">
        <h2 className="font-semibold text-base text-text-primary mb-3">
          Common Feelings During Pregnancy
        </h2>
      ...
      <section className="mb-6">
        <div className="bg-red-50 rounded-2xl border border-red-200 p-4">
          ...
          <p className="text-xs text-red-700 mb-3">
            Tell your nurse, doctor, or a trusted person if you experience any
            of these:
          </p>
      ...
      <section className="mb-6">
        <div className="bg-blue-50 rounded-2xl border border-blue-200 p-4">
          <h2 className="font-semibold text-sm text-blue-800 mb-3">
      ...
      <div className="bg-rose-50 rounded-2xl border border-rose-200 p-4 mb-5">
        ...
        <p className="text-xs text-rose-600 mt-1">
          Tell your ANC nurse or doctor at your next visit; they can help.
        </p>
      </div>
      ...
      <div className="p-4 bg-purple-50 rounded-2xl border border-purple-200">
        ...
        <p className="text-xs text-text-secondary mb-3">
          MamaGuide is here to listen and support you, any time of day.
        </p>
        <Link
          to={ROUTES.CHAT}
