...
const maternalVaccines = [
  {
    ...
    protects:
      "You and your baby against tetanus, a life-threatening infection",
    sideEffects:
      "Mild soreness at injection site, slight fever (normal and temporary)",
    important: true,
  ...
  },
  {
    ...
    protects:
      "Against severe flu complications; flu during pregnancy can be serious",
  ...
  },
  {
    ...
    protects: "Against hepatitis B, which can be passed to baby during birth",
...
const babyVaccines = [
  ...
  },
  {
    ...
    vaccines: [
      { name: "OPV-1", protects: "Polio" },
      {
        ...
        protects: "Diphtheria, Tetanus, Whooping Cough, Hepatitis B, Hib",
      },
  ...
  },
  {
    ...
    vaccines: [
      {
        name: "Measles (MCV1)",
        protects: "Measles, a serious childhood illness",
      },
...
const myths = [
  {
    ...
    fact: "This has been thoroughly disproven by hundreds of scientific studies. Vaccines are safe.",
  },
  {
    myth: "My baby is too small or weak for vaccines",
    fact: "Premature and small babies need vaccines even more urgently; they are at higher risk.",
  },
  {
    myth: "Vaccines contain harmful ingredients",
    fact: "All vaccine ingredients are tested for safety. The benefits far outweigh any very rare risks.",
  },
  {
    myth: "Natural immunity is better than vaccine immunity",
    fact: "Getting the disease is far more dangerous than getting the vaccine. Don't risk your baby's life.",
  },
];
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <p className="text-sm text-text-secondary leading-relaxed mb-4">
        Vaccines are one of the most effective ways to protect your baby from
        dangerous diseases. Most vaccines are{" "}
        <strong>free at government health facilities</strong> in Nigeria.
      </p>
      ...
      <div className="flex items-center gap-2 p-3.5 bg-sage-50 border border-sage-200 rounded-xl mb-6">
        ...
        <p className="text-xs text-sage-700">
          Based on Nigeria National Immunisation Schedule (NIS) and WHO
          recommendations.
        </p>
      </div>
          ...
          {maternalVaccines.map((v) => (
            ...
            >
              <div className="flex items-start justify-between gap-2 mb-2">
                ...
                <Badge variant={v.badge.variant} size="sm" className="shrink-0">
                  {v.badge.text}
                </Badge>
              </div>
      ...
      <div className="p-4 bg-rose-50 rounded-2xl border border-rose-200">
        ...
        <p className="text-xs text-text-secondary mb-3">
          Ask MamaGuide for more information about any vaccination.
        </p>
        <Link
          to={ROUTES.CHAT}
