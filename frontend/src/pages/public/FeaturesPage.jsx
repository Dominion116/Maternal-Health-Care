...
const coreFeatures = [
  {
    ...
    description: 'Ask any pregnancy question in plain language. MamaGuide understands your concern and gives clear, trustworthy answers instantly — no jargon, no waiting.',
