            ...
            <div className="space-y-10">
              ...
              <Section id="medical-disclaimer" number="2" icon={AlertTriangle} title="Medical Disclaimer">
                ...
                <Ul items={[
                  ...
                  'Responses from MamaGuide are generated by an AI trained on maternal health literature — they may not apply to your specific clinical situation',
              ...
              <Section id="ai-limitations" number="5" icon={Cpu} title="AI Limitations">
                ...
                <Ul items={[
                  ...
                  'The AI\'s training data is limited to its training period — very recent medical developments may not be reflected',
                  'The AI responds in English only — Pidgin, Yoruba, Hausa, and Igbo support are planned but not yet available',
                  'Response quality depends on how clearly you phrase your question — provide as much relevant detail as possible',
                ]} />
              ...
              <Section id="liability" number="11" icon={Scale} title="Limitation of Liability">
                ...
                <Ul items={[
                  'MamaGuide is provided "as is" without warranties of any kind — express, implied, or statutory',
